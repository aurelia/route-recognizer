...
describe('route recognizer', () => {
  ...
  it(`can set case insensitive route over case sensitive recognizer`, () => {
    let recognizer = new RouteRecognizer();
    recognizer.setCaseSensitive(true);
    const routeTest = {
      title: 'case insensitive route',
      route: { 'path': 'CasE/InSeNsItIvE', 'handler': { 'name': 'static' }, 'caseSensitive': false },
      isDynamic: false,
